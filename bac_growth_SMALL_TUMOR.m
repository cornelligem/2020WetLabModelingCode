...
% average to a vessel
r = 1 + 1/sqrt(30); %CHANGE HERE https://cancerres.aacrjournals.org/content/63/17/5188.long
dispoints= 1000;
xmesh= linspace(0, r, dispoints);
 
tend= 2 * 7 * 24 * 60 * 60; % 1 week in seconds CHANGE HERE
tpoints= 1000;
...
function [c, f, s] = pdefun(x, t, u, dudx)
    ...
    % outside of it
    r= 1; %radius of the tumor in mm CHANGE THIS
